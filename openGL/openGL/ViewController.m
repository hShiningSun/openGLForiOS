...
- (void)viewDidLoad {
    [super viewDidLoad];
//    OpenGLView *testView = [[OpenGLView alloc]initWithFrame:CGRectMake(100, 100, 200, 100)];
...
//// 建立openGL 的上下文，支持的版本为2.0
//self.context = [[EAGLContext alloc]initWithAPI:kEAGLRenderingAPIOpenGLES2];
//
//// openGL 技术实现的view
//
//GLKView *testView = (GLKView *)self.view;
//testView.context = self.context;
//
//
//
//// 渲染缓冲区的颜色格式，默认 GLKViewDrawableColorFormatRGBA8888.
//testView.drawableColorFormat = GLKViewDrawableColorFormatRGBA8888;
//// 模板缓冲区格式
//testView.drawableDepthFormat = GLKViewDrawableDepthFormat24;
//
...
//
//// 把标识符绑定到GL_ARRAY_BUFFER(数组)上
//glBindBuffer(GL_ARRAY_BUFFER, buffer);
//
//// 把顶点数据从cpu内存复制到gpu(图形处理器)内存
...
//glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, index);//节点
//glBufferData(GL_ELEMENT_ARRAY_BUFFER, sizeof(indices), indices, GL_STATIC_DRAW);
//
//// 顶点数据缓存  GLKVertexAttribPosition 向着色器提供顶点位置
//glEnableVertexAttribArray(GLKVertexAttribPosition);
//
...
//
////纹理贴图
//NSString* filePath = [[NSBundle mainBundle] pathForResource:@"beautiful" ofType:@"png" inDirectory:@"Images" ];
